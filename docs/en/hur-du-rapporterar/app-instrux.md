...
![Menu in ButterflyCount](../../assets/images/app/bilaga1-steg1-meny.png)

**Step 2**: Under Settings, choose Species Lists.

![Settings, Species Lists](../../assets/images/app/bilaga1-steg2-installningar.png)

**Step 3**: Download the species lists Sweden and EBMS moths.

![Downloaded species lists](../../assets/images/app/bilaga1-steg3-artlistor.png)

## Register a trap emptying

**Step 1**: Choose Moth survey on the home screen.

![Moth survey in the menu](../../assets/images/app/bilaga3-steg1-meny.jpg)

**Step 2**: Check that it says "Moth trap" on the top row, tap to choose your site.

![Survey details](../../assets/images/app/bilaga3-steg2-inventeringsdetaljer.png)

**Step 3**: Choose your site from the list.

![List of moth traps](../../assets/images/app/bilaga3-steg3-fallor-lista.jpg)

**Step 4**: Date and reporter are pre-filled but can be changed. Add a comment and weather if you like.

![Date and reporter](../../assets/images/app/bilaga3-steg4-datum-rapportor.png)

**Step 5**: Add a species, either by text search or by photo.

![Add species](../../assets/images/app/bilaga3-steg5-lagg-till-art.png)

**Step 6**: Type a few letters to get suggestions — both Swedish and scientific names work.

![Species search](../../assets/images/app/bilaga3-steg6-artsokning.png)
...
![Gallery, multiple photos](../../assets/images/app/bilaga3-steg7-galleri.png)

**Step 2**: The classifier processes the photos; some end up as "Unknown" if it's uncertain.

![Image processing](../../assets/images/app/bilaga3-steg8-obestamd.png)

**Step 3**: Tap an observation to see/change the species identification.

![Species identification complete](../../assets/images/app/bilaga3-steg9-art-bestamd.png)

**Step 4**: Under Edit occurrence, adjust the count inside/outside the trap and see how confident the classifier was.

![Edit occurrence](../../assets/images/app/bilaga3-steg10-andra-forekomst.png)
...
![Back to the home screen](../../assets/images/app/bilaga3-aterhamtning-1.png)

![Surveys, started report](../../assets/images/app/bilaga3-aterhamtning-2.png)
