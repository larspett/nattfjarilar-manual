---
title: Sätta ut fällor - allmänna principer
---
...
![Illustration av fyra fällplatser (A–D) i ett halvöppet hagmarkslandskap, med 50 m skalstock](../assets/images/fallplatser-oversikt.png)
...
![Exempel på de sex fotoriktningarna: fälla (vy), himmel (rakt upp), norr, öster, söder, väster](../assets/images/habitatdok-foton.png)
