---
title: Ändra observationer
---

# Ändra en observation i efterhand

Observationer som du lagt in via appen ButterflyCount kan ändras både i appen och på hemsidan ([butterfly-monitoring.net](https://butterfly-monitoring.net/)), oavsett var de ursprungligen registrerades. Samma inloggning används på båda ställena.
...
- Är artbestämningen osäker, testa gärna apparna [ObsIdentify](https://waarneming.nl/) och [Artsorakel](https://orakel.artsdatabanken.no/) som brukar vara pålitliga för en snabb kontroll.
