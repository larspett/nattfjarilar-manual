...
- **hur-du-satter-ut/** — site-specifikationer (deployment rules, lottery), gradient-lund-abisko, rutnat-lund-uppsala **(now includes real-basemap maps with numbered 1-9 trap positions for all 4 grid squares — real registered coordinates for Silvåkra/Björnstorp, preliminary planning positions for the two Uppland sites pending real registration)**
